...
int main() {
    ...
    file << "Num_Threads,std:sort_time,min_max_quicksort_time,min_max_quicksort_speedup,__gnu_parallel_time,__gnu_parallel_speedup\n";
    ...
    for (int i = 1; i <= 128; i++) {
        ...
        file << i << "," << time_std_sort << "," << time_min_max_quicksort << "," << time_std_sort / time_min_max_quicksort
